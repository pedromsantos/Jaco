...
public class NoteShould
{
	...
	public void MeasureIntervalsBetweenCShapAndAllOtherNotes()
	{
		...
		note.IntervalTo(new Note(Pitch.ESharp, Duration.Quarter, Octave.C1)).Should().Be(Interval.MajorThird);
		...
		note.IntervalTo(new Note(Pitch.ASharp, Duration.Quarter, Octave.C1)).Should().Be(Interval.MajorSixth);
		note.IntervalTo(new Note(Pitch.B, Duration.Quarter, Octave.C1)).Should().Be(Interval.MinorSeventh);
		note.IntervalTo(new Note(Pitch.BSharp, Duration.Quarter, Octave.C1)).Should().Be(Interval.MajorSeventh);
	...
	public void MeasureIntervalsBetweenDFlatAndAllOtherNotes()
	{
		...
		note.IntervalTo(new Note(Pitch.BFlat, Duration.Quarter, Octave.C1)).Should().Be(Interval.MajorSixth);
		...
		note.IntervalTo(new Note(Pitch.EFlat, Duration.Quarter, Octave.C2)).Should().Be(Interval.MajorNinth);
		note.IntervalTo(new Note(Pitch.GFlat, Duration.Quarter, Octave.C2)).Should().Be(Interval.PerfectEleventh);
		note.IntervalTo(new Note(Pitch.BFlat, Duration.Quarter, Octave.C2)).Should().Be(Interval.MajorThirteenth);
	}
}
